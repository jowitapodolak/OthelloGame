...
public class GameState {
	...
	public int[] countTokens(){
    	...
    	return new int[]{tokens1, tokens2}; // return array of two elements - first score for player 1
	}
	...
	public boolean isPossibleToPutToken(Position place)
	{
    ...
    public boolean insertToken(Position place) {
		...
		isPossibleToPutToken(place); // me: outsourced to isPossibleToPutToken
